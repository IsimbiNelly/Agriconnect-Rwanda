...
from routers.buyers.auth import router as buyers_auth_router
from routers.farmers.product_management import router as farmer_product_router
from routers.farmers.auth import router as farmer_auth
...
app.include_router(buyers_auth_router)
app.include_router(farmer_product_router)
app.include_router(farmer_auth)
